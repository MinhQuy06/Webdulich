...
// hiển thị danh sách tour lên bảng, nếu có lỗi kết nối API thì hiển thị thông báo lỗi
...
// hàm load dữ liệu tour và hiển thị lên bảng, nếu có lỗi kết nối API thì hiển thị thông báo lỗi
...
// Khi admin click xem tin nhắn, hiển thị chi tiết trong prompt và cho phép đổi trạng thái
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  document.getElementById("sidebarToggle")?.addEventListener("click", (e) => {
    ...
    console.log(
      "Hamburger clicked! Window width:",
      window.innerWidth,
      "Sidebar:",
      sb,
    );
  ...
  // Close sidebar when clicking on backdrop (::before pseudo-element) on mobile
  document.getElementById("sidebar")?.addEventListener("click", (e) => {
    if (window.innerWidth <= 768 && e.target === e.currentTarget) {
      // This handles clicks outside the sidebar content
      document.getElementById("sidebar")?.classList.remove("mobile-open");
    }
  });

  // Close sidebar when clicking on main content area on mobile
  document.getElementById("adminMain")?.addEventListener("click", (e) => {
    if (window.innerWidth <= 768) {
      const sb = document.getElementById("sidebar");
      if (
...
/* ─────── DIRECT EVENT LISTENERS (non-DOM dependent) ─────── */
// Fallback: attach hamburger event listener immediately if element exists
if (document.getElementById("sidebarToggle")) {
  document.getElementById("sidebarToggle").addEventListener("click", (e) => {
    ...
    if (window.innerWidth <= 768) {
      sb?.classList.toggle("mobile-open");
      console.log("✓ Mobile hamburger clicked - mobile-open toggled");
    }
  });
}
