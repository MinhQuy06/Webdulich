...
// Hàm load thông tin user đã đăng nhập vào form (nếu có)
// ở tr
...
// Hàm xử lý submit form hỗ trợ ở trang hotro.html
// đưa dữ liệu vào db.json thông qua API của json-server
async function submitSupportForm() {
  ...
  if (!name) {
    ...
    // Nếu đã nhập tên, xóa lỗi (nếu có)
